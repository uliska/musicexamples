...
If the width of the image is smaller then it will be left-aligned by default, but you can override the alignment manually with standard LaTeX commands.
\\\todo{this has to be thought about again \ghIssue{15}}.\\
If the image is too large then it will flow over the right margin (so far).
